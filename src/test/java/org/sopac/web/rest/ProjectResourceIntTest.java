...
public class ProjectResourceIntTest {
    ...
    private static final Reflected DEFAULT_REFLECTED_IN_BUDGET = Reflected.YES;
    private static final Reflected UPDATED_REFLECTED_IN_BUDGET = Reflected.NO;
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project()
            ...
            .reflectedInBudget(DEFAULT_REFLECTED_IN_BUDGET)
    ...
    public void createProject() throws Exception {
        ...
        assertThat(testProject.getReflectedInBudget()).isEqualTo(DEFAULT_REFLECTED_IN_BUDGET);
    ...
    public void getAllProjects() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].reflectedInBudget").value(hasItem(DEFAULT_REFLECTED_IN_BUDGET.toString())))
    ...
    public void getProject() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects/{id}", project.getId()))
            ...
            .andExpect(jsonPath("$.reflectedInBudget").value(DEFAULT_REFLECTED_IN_BUDGET.toString()))
    ...
    public void updateProject() throws Exception {
        ...
        updatedProject
            ...
            .reflectedInBudget(UPDATED_REFLECTED_IN_BUDGET)
        ...
        assertThat(testProject.getReflectedInBudget()).isEqualTo(UPDATED_REFLECTED_IN_BUDGET);
